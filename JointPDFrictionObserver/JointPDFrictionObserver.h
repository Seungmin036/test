...
class JointPDFrictionObserver : public NRMKControl::ControlAlgorithm<ROBOT>
{
...
public:
    ...
    JointPDFrictionObserver() = default;
...
class JointPDFrictionObserverCreator : public NRMKControl::ControlAlgorithmCreator
{
CONTROL_CREATOR_BODY(JointPDFrictionObserver)
};